...
static nwamui_wifi_essid_t demo_essids[] = {
    ...
    {"essid_wep ooooooooooooooooooooooooooooooooooooooooooooooooooooooo", NWAMUI_WIFI_SEC_WEP_HEX, "BB:bb:cc:dd:ee:ff", "g", 54, NWAMUI_WIFI_STRENGTH_FAIR, NWAMUI_WIFI_WPA_CONFIG_AUTOMATIC },
